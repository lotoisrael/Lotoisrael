...
(function () {
  ...
  bg.innerHTML = `<div class="modal acc-modal" style="max-width:540px"><div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:12px;border-bottom:2px solid #f5c0c8;padding-bottom:12px"><h2 id="terms-title" style="font-size:clamp(16px,3vw,20px);font-weight:900;color:#c8102e">📋 תנאי שימוש</h2><button onclick="closeTermsModal()" aria-label="סגור" style="background:none;border:none;font-size:22px;cursor:pointer;color:#333;padding:4px 8px">✕</button></div><p style="font-size:11px;color:#555;margin-bottom:14px">עודכן לאחרונה: מרץ 2026</p><div style="display:flex;flex-direction:column;gap:16px;font-size:12px;color:#222;line-height:1.9;text-align:right"><div><h3 style="font-size:13px;font-weight:900;color:#c8102e;margin-bottom:4px">1. כללי</h3><p>האתר <strong>לוטו ישראל</strong> מופעל על ידי לוטו ישראל. השימוש באתר מהווה הסכמה מלאה לתנאי שימוש אלה.</p></div><div><h3 style="font-size:13px;font-weight:900;color:#c8102e;margin-bottom:4px">2. מטרת השירות</h3><p>האתר מספק כלי לבידור ולניתוח סטטיסטי בלבד. המספרים אינם מהווים המלצה או הבטחה לזכייה. האתר אינו קשור למפעל הפיס.</p></div><div><h3 style="font-size:13px;font-weight:900;color:#c8102e;margin-bottom:4px">3. גיל מינימלי</h3><p>השימוש מותר לבני <strong>18 ומעלה בלבד</strong>. קטינים אינם רשאים לעשות שימוש בשירותי האתר.</p></div><div><h3 style="font-size:13px;font-weight:900;color:#c8102e;margin-bottom:4px">4. תשלומים והחזרים</h3><p>התשלומים מתבצעים דרך Stripe. לאחר חשיפת המספרים <strong>לא ניתן לבצע החזר כספי</strong>. לבעיות פנה תוך 48 שעות.</p></div><div><h3 style="font-size:13px;font-weight:900;color:#c8102e;margin-bottom:4px">5. הגבלת אחריות</h3><p>החברה לא תישא בכל אחריות לנזק הנובע מהסתמכות על תוצאות האתר.</p></div><div><h3 style="font-size:13px;font-weight:900;color:#c8102e;margin-bottom:4px">6. קניין רוחני</h3><p>כל התכנים והאלגוריתמים מוגנים בזכויות יוצרים. אין להעתיק ללא אישור בכתב.</p></div><div><h3 style="font-size:13px;font-weight:900;color:#c8102e;margin-bottom:4px">7. פרטיות ועוגיות</h3><p>האתר משתמש ב-Google Analytics לניתוח תנועה אנונימי.</p></div><div><h3 style="font-size:13px;font-weight:900;color:#c8102e;margin-bottom:4px">8. שינויים בתנאים</h3><p>החברה רשאית לעדכן תנאים בכל עת. המשך השימוש מהווה הסכמה לתנאים המעודכנים.</p></div><div><h3 style="font-size:13px;font-weight:900;color:#c8102e;margin-bottom:4px">9. דין וסמכות שיפוט</h3><p>תנאי שימוש אלה כפופים לדיני מדינת ישראל. כל סכסוך יובא לבית המשפט במחוז תל אביב-יפו.</p></div><div><h3 style="font-size:13px;font-weight:900;color:#c8102e;margin-bottom:4px">10. יצירת קשר</h3><p>לשאלות: <a href="mailto:Info@lotoisrael.com" style="color:#c8102e;font-weight:700">Info@lotoisrael.com</a></p></div></div><button class="acc-close-btn" onclick="closeTermsModal()" style="margin-top:18px">סגור</button></div>`;
